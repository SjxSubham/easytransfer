...
import { getClientIP, sanitizeFilename, isValidFileSize, formatFileSize } from '@/lib/utils';
  ...
  try {
    ...
    if (!rateLimitResult.allowed) {
      return NextResponse.json(
        {
          success: false,
          error: rateLimitResult.message || 'Rate limit exceeded. You can only upload 3 files per hour.',
          remaining: 0,
